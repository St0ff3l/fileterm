...
export type TerminalViewActionsOptions = {
  isMac: boolean
  findOpen: boolean
  findQuery: string
  ...
  onSplitPaneRef: MutableRef<((direction: SplitPaneDirection) => void) | undefined>
...
export function useTerminalViewActions({
  isMac,
  findOpen,
  findQuery,
  findCaseSensitive,
