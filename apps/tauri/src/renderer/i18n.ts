...
const zhCN = {
  ...
  securitySettingsHint: '用主密码保护当前工作区，并统一管理 WebDAV / S3 远程备份密码。',
  ...
  securityEnableLock: '启用锁屏保护',
  securityEnableLockHint: '开启后，应用程序会在启动时或空闲一段设定时间后自动锁定。',
  securityLockPasswordRequired: '请先设置主密码，再启用锁屏保护。',
  securityIdleLockMinutes: '空闲锁定（分钟）',
  securityIdleLockMinutesHint: '在 X 分钟无活动后自动锁定应用程序。设置为 0 以禁用。',
  securityDecreaseIdleLock: '减少空闲锁定时间',
  securityIncreaseIdleLock: '增加空闲锁定时间',
  securityMinutes: '分钟',
  ...
  securityLockedDescription: '为了保护当前工作区，请输入主密码解锁会话。',
  securityUnlockPassword: '主密码',
  securityUnlockPasswordPlaceholder: '输入主密码以解锁',
  securityUnlock: '解锁会话',
  securityUnlockRequired: '请输入主密码。',
  securityUnlockFailed: '主密码不正确，请重试。',
...
const enUS: typeof zhCN = {
  ...
  securitySettingsHint:
    'Protect the current workspace with a master password and manage the shared WebDAV / S3 backup password.',
  ...
  securityEnableLock: 'Enable session lock',
  securityEnableLockHint: 'When enabled, FileTerm locks at startup or after the configured idle period.',
  securityLockPasswordRequired: 'Set a master password before enabling the session lock.',
  securityIdleLockMinutes: 'Idle lock (minutes)',
  securityIdleLockMinutesHint: 'Lock the application after X minutes without activity. Set to 0 to disable.',
  securityDecreaseIdleLock: 'Decrease idle lock time',
  securityIncreaseIdleLock: 'Increase idle lock time',
  ...
  securityLockedDescription: 'Enter the master password to unlock and return to the current workspace.',
  securityUnlockPassword: 'Master password',
  securityUnlockPasswordPlaceholder: 'Enter the master password to unlock',
  securityUnlock: 'Unlock session',
  securityUnlockRequired: 'Enter the master password.',
  securityUnlockFailed: 'The master password is incorrect. Try again.',
