...
mod gex {
    ...
    #[test]
    fn legacy_client_config_accepts_the_comware_request_range() {
        let params = client::GexParams::for_legacy_client_config(1024, 1024, 8192).unwrap();
    ...
    #[test]
    fn legacy_client_config_still_rejects_weak_values() {
        let error = client::GexParams::for_legacy_client_config(512, 1024, 8192).unwrap_err();
