...
function toProfile(id: string, input: CreateProfileInput): ConnectionProfile {
  if (input.type === 'serial') {
    return {
      ...
      deviceSerialNumber: input.deviceSerialNumber || undefined,
      deviceVendorId: input.deviceVendorId,
      deviceProductId: input.deviceProductId,
      devicePortType: input.devicePortType,
      ...
      dtrOnClose: input.dtrOnClose,
      rtsOnClose: input.rtsOnClose,
      serialCharDelayMs: input.serialCharDelayMs,
      serialLineDelayMs: input.serialLineDelayMs,
      serialReceiveIdleTimeoutMs: input.serialReceiveIdleTimeoutMs,
      serialWriteTimeoutMs: input.serialWriteTimeoutMs,
      rs485Mode: input.rs485Mode,
      rs485RtsOnSend: input.rs485RtsOnSend,
      rs485DelayRtsBeforeSendMs: input.rs485DelayRtsBeforeSendMs,
      rs485DelayRtsAfterSendMs: input.rs485DelayRtsAfterSendMs,
