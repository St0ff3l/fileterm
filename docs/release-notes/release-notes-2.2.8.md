...
FileTerm 2.2.8 improves folder upload reliability across Linux, macOS, and Windows with stronger diagnostics and complete traversal.
...
完整变更记录请查看 [v2.2.7 与 v2.2.8 的比较](https://github.com/St0ff3l/fileterm/compare/v2.2.7...v2.2.8)。
...
See the [comparison between v2.2.7 and v2.2.8](https://github.com/St0ff3l/fileterm/compare/v2.2.7...v2.2.8) for the complete change set.
